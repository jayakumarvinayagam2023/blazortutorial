...
{
    public partial class FarmBlazorRouter : IComponent, IHandleAfterRender, IDisposable
    {
        ...
        ILogger<FarmBlazorRouter> _logger;
        ...
        {
            _logger = LoggerFactory.CreateLogger<FarmBlazorRouter>();
        ...
        internal virtual void Refresh(bool isNavigationIntercepted)
        {
            ...
            else
            {
                if (!isNavigationIntercepted)
                {
                    ...
                    // Only show the NotFound content if the application developer pragmatically got us here i.e we did not
        ...
        internal async ValueTask RunOnNavigateAsync(string path, bool isNavigationIntercepted)
        {
            ...
            // Then make sure that the task has been completely canceled or completed
