...
namespace FarmBlazor.Core
{
    public class EditFieldCollection : IEnumerable
    {
        ...
        public void ResetValues() => _items.ForEach(item => item.Reset());

        public IEnumerator GetEnumerator() => new EditFieldCollectionEnumerator(_items);
    ...
    public class EditFieldCollectionEnumerator : IEnumerator
    {
        ...
        void IEnumerator.Reset() => _cursor = -1;
